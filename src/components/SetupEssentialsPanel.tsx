  ...
  return (
    <section aria-labelledby="setup-essentials-title" className="setup-essentials">
      <header className="setup-essentials__header">
        ...
        <p>
          Windows自身の設定が必要な項目は設定画面へ案内し、Totonoeで扱える配置だけは
          保存内容を確認してから復元します。
        </p>
      </header>
          ...
          <div className="setup-essential-card__copy">
            ...
            <div>
              ...
              <p>
                ...
                Windowsの設定で選びます。TotonoeはUserChoiceを直接書き換えず、設定画面だけを開きます。
              </p>
            </div>
          </div>
          <ActionMetadata
            action={defaultAppsAction}
            currentLabel={defaultAppsAction?.currentState?.label ?? "TotonoeによるOS変更なし"}
          />
          <button
        ...
        <article className="setup-essential-card setup-essential-card--wide">
          <div className="setup-essential-card__copy">
            ...
            <div>
              ...
              <p>
                Totonoeは<strong>今開いている対象ウィンドウの位置と表示状態だけ</strong>を保存・復元します。
