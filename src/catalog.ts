...
export const EVERYDAY_FEATURE_GUIDES = [
  ...
  { id: "save-layout", result: "アプリ起動込みの作業環境を保存する", featureName: "Workspaces", description: "PowerToysは複数アプリの起動と配置をまとめます。現在開いているウィンドウの位置だけなら、上のTotonoe配置保存を使います。", provider: "powertoys" },
...
const OBSERVATION_FALLBACKS = [
  ...
  },
  {
    ...
    actionVersion: 1,
    name: "既定のアプリを選ぶ",
    description: "ファイルやリンクを開くアプリを選ぶWindows設定へ案内します。TotonoeはUserChoiceを直接書き換えません。",
  ...
  },
  {
    ...
    detailPoints: [
      ...
      "Totonoeは既定デバイスを変更せず、Windowsのサウンド設定を開きます。",
    ],
