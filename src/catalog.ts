...
const OBSERVATION_FALLBACKS = [
  ...
  },
  {
    ...
    actionVersion: 1,
    name: "既定のアプリを選ぶ",
    description: "ファイルやリンクを開くアプリを選ぶWindows設定へ案内します。PCカスタムはUserChoiceを直接書き換えません。",
    ...
    availability: "read_only",
    methodClass: "public_api",
    methodSummary: "Windowsのms-settings:defaultappsを開き、選択はWindows設定に任せる",
    desiredState: "Windowsの「既定のアプリ」で利用者が選ぶ",
    detailPoints: [
      "UserChoiceにはWindowsが整合性確認に使うhashがあり、値の直接書き換えは安全なsetterではありません。",
      "validate・backup・applyはOS変更を明示的に拒否します。",
  ...
  },
  {
    ...
    availability: "read_only",
    methodClass: "public_api",
    methodSummary: "MMDeviceEnumeratorで実デバイスを読み取り、切り替えはms-settings:soundへ案内",
