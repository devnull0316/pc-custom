...
use crate::actions::{
    ACTIVE_SCHEME_CHECK_ACTION, COLOR_MODE_ACTION, PREVENT_SLEEP_ACTION,
    PROCESS_WATCH_ACTION, SHOW_EXTENSIONS_ACTION, SHOW_HIDDEN_ACTION,
};

use super::{Action, ActionError, ActionErrorCode, ActionId, ActionResult, ActionStage};

static REGISTERED_ACTIONS: [&'static dyn Action; 6] = [
