...
use crate::actions::{
    ACTIVE_SCHEME_CHECK_ACTION, CLOCK_SECONDS_ACTION, COLOR_MODE_ACTION, COMPACT_VIEW_ACTION,
    ITEM_CHECKBOXES_ACTION, PREVENT_SLEEP_ACTION, PROCESS_WATCH_ACTION, SHOW_EXTENSIONS_ACTION,
...
static REGISTERED_ACTIONS: [&'static dyn Action; 12] = [
